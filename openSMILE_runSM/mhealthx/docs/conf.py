# -*- coding: utf-8 -*-
#
# mhealthx documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  3 13:44:36 2016.
#
...
# of the sidebar.
#html_logo = '_static/mindboggle_logo_small.jpg'
...
latex_documents = [
    (master_doc, 'mhealthx.tex', u'mhealthx documentation',
     u'Arno Klein', 'manual'),
]
...
man_pages = [
    (master_doc, 'mhealthx', u'mhealthx documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mhealthx', u'mhealthx documentation',
     author, 'mhealthx', 'Automate feature extraction from sensor data.'),
]
